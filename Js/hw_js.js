...
function ageColc(age_1,age_2,age_3) {
    if (age_1 < age_2) {
        console.log("You don't have access cause your age is " + age_1 + " It's less then");
       } else if (age_1 >= age_2 && age_1 < age_3) {
           console.log("Welcome !");
...
function ageColc_2(age_1,age_2,age_3) {

    if (typeof age_1 != 'number' || typeof age_2 != 'number' || typeof age_3 != 'number' ) {
        console.log("Error! It isn't number");
    } else if (age_1 < age_2) {
        console.log("You don't have access cause your age is " + age_1 + " It's less then");
       } else if (age_1 >= age_2 && age_1 < age_3) {
           console.log("Welcome !");
...
function ageColc_3(age_1,age_2,age_3) {
        age_1 = Number(age_1);
        age_2 = Number(age_2);
        age_3 = Number(age_3);
         if (age_1 < age_2) {
...
// 4***: Преобразовать задание 3* таким образом, чтобы возраст вводится используя функцию prompt в привязанной верстке
 age_1 = prompt('Enter age_1');
 age_2 = prompt('Enter age_2');
 age_3 = prompt('Enter age_3');

function ageColc_4(age_1,age_2,age_3) {   
     if (age_1 < age_2) {
    console.log("You don't have access cause your age is " + age_1 + " It's less then");
   } else if (age_1 >= age_2 && age_1 < age_3) {
       console.log("Welcome !");
